...
"""
Input format:
A number of the maximum square.

Output format:
A sequnce of squares with space between them.
"""

# Catches a maximum square.
max_square = int(input())

# Creates a sequence of squares.
answer = square_sequence(max_square)

# Prints the answer with space between the squares.
print(*answer, sep=' ')
